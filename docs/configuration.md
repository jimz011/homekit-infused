...
| title | no | view_name | Set the title of the view, if undefined it will use the name of the view instead, you can NOT use templates for the title! To hide the title entirely set `title: hide`, this will ALSO hide the subtitle! |

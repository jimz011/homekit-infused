...
You can setup notifications to show in the subtitle of the header. You must set this up yourself by opening `/hki-user/notifications.yaml`. For more information and examples [click here](addons/addons/notifications.md)!

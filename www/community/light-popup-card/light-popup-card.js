 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function R(t,e){const{element:{content:r},parts:n}=t,i=document.createTreeWalker(r,133,null,!1);let s=O(n),o=n[s],a=-1,h=0;const c=[];let l=null;for(;i.nextNode();){a++;const t=i.currentNode;for(t.previousSibling===l&&(l=null),e.has(t)&&(c.push(t),null===l&&(l=t)),null!==l&&h++;void 0!==o&&o.index===a;)o.index=null!==l?-1:o.index-h,s=O(n,s),o=n[s]}c.forEach(t=>t.parentNode.removeChild(t))}const H=t=>{let e=11===t.nodeType?0:1;const r=document.createTreeWalker(t,133,null,!1);for(;r.nextNode();)e++;return e},O=(t,e=-1)=>{for(let r=e+1;r<t.length;r++){const e=t[r];if(u(e))return r}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
            ...
            <div class="popup-inner" @click="${t=>this._close(t)}">
                ...
                ${e.attributes.supported_features>s?F`
                    ...
                    <div class="range-holder" style="--slider-height: ${p};--slider-width: ${d};">
                        <input type="range" style="--slider-width: ${d};--slider-height: ${p}; --slider-border-radius: ${i}" .value="${"off"===e.state?0:Math.round(e.attributes.brightness/2.55)}" @change=${t=>this._setBrightness(e,t.target.value)}>
                    </div>
                `:F`
                    <h4>${Bt(this.hass.localize,e,this.hass.language)}</h4>
                    <div class="switch-holder" style="--switch-height: ${g};--switch-width: ${f};">
                        <input type="range" style="--switch-width: ${f};--switch-height: ${g}; --slider-border-radius: ${i}" value="0" min="0" max="1" .value="${l}" @change=${()=>this._switch(e)}>
                    </div>
                `}
                ...
                <div class="action-holder">
                    ...
                    ${this.actionRows.map(t=>{b++;var e=0;return F`
                        <div class="action-row">
                        ${t.map(t=>(e++,F`
                            <div class="action" @click="${t=>this._activateAction(t)}" data-service="${b}#${e}">
                                <span class="color" style="background-color: ${t.color};border-color: ${t.color};">${t.icon?F`<ha-icon icon="${t.icon}" />`:F``}</span>
